...
const inputEventFunction = () => {
  ...
  if (keywords.length === 1 && keywords[0] === '') {
    // 未输入关键词
    // resultContent.innerHTML = '<div class="no-result is-unselectable">请输入关键词...</div>';
  } else if (resultItems.length === 0) {
    // 无结果
    resultContent.innerHTML = '<div class="no-result is-unselectable">未查询到结果...</div>';
  } else {
